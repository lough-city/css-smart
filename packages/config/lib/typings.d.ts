...
export declare enum NPM_LIFE_CYCLE {
    /**
     * 准备好前
     */
    prepare = "prepare",
 ...
 * package.json
 */
export declare type IPackage = RequiredConfig & Partial<DescriptionConfig> & Partial<NormConfig> & Partial<ScriptConfig> & Partial<DependenciesConfig> & Partial<PublishConfig> & Partial<TripartiteConfig> & Partial<TripartiteConfig>;
